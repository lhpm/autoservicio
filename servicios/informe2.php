...
<title>Repuestos - Autoservicio</title>
...
$result = mysql_query("SELECT * FROM detalles INNER JOIN repuestos 
  ON repuestos.orden = detalles.orden ORDER BY id DESC");
...
<div class="container">
  <h2>Listado de Repuestos por Orden</h2>
...
echo "<thead><tr> <th>MARCA</th> <th>ORDEN</th> </tr></thead>";
...
echo '<td>Repuesto: ' . mysql_result($result, $i, 'repuesto') . '
Valor: ' . mysql_result($result, $i, 'valor') . '</td>';
