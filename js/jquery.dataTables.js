...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input class="form-control" type="text" />';
...
/* LLAMO LOS JQUERY DE CONSULTA.PHP AQUI, YA QUE AL FILTRAR, BUSCAR LOS Registros

DE MAS DE 10 QUE SE MUESTRAN NO FUNCIONAN*/
